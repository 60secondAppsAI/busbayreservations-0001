            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Issue Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="IssueId" type="text" placeholder="Enter IssueId" v-model="assignedToDetails.issueId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Assignee Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AssigneeId" type="text" placeholder="Enter AssigneeId" v-model="assignedToDetails.assigneeId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
