						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="CommenterId" type="text" placeholder="Enter CommenterId" v-model="commentToAdd.commenterId"></base-input>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Issue Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Commenter Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CommenterId" type="text" placeholder="Enter CommenterId" v-model="commentDetails.commenterId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
